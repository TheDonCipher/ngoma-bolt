...
const formSchema = z.object({
  title: z
    ...
    .refine(validateInput, 'Invalid characters in title'),
  description: z
    .string()
    .min(1, 'Description is required')
    .refine(validateInput, 'Invalid characters in description'),
  ...
  copyrightInfo: z
    ...
    .optional()
    .refine(
      (input) => input === undefined || validateInput(input),
      'Invalid characters in copyright info'
    ),
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea disabled={isLoading} {...field} rows={4} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
