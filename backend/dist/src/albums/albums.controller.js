...
let AlbumsController = class AlbumsController {
    ...
    async mintAlbum(coverImage, createAlbumDto) {
        return this.albumsService.mintAlbumNFT(createAlbumDto, createAlbumDto.trackTokenIds, coverImage.buffer);
    }
    async purchaseAlbum(tokenId) {
        return this.albumsService.purchaseAlbum(tokenId);
    }
