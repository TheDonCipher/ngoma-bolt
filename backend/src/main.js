...
var rate_limiter_guard_1 = require("./common/guards/rate-limiter.guard");
var compression = require("compression");
var helmet = require("helmet");
var sanitize = require("sanitize-html");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, prismaService, config, document;
                ...
                case 2:
                    ...
                    app.useGlobalPipes(new common_1.ValidationPipe({
                        ...
                        sanitizeOptions: {
                            ...
                            allowedAttributes: __assign(__assign({}, sanitize.defaults.allowedAttributes), { img: ['src', 'alt'] }),
                        },
                    }));
                    // Rate limiting
