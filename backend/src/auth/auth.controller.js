...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.getNonce = function (address) {
        return this.authService.getNonce(address);
    };
    AuthController.prototype.verify = function (message, signature) {
        return this.authService.verify(message, signature);
    };
    __decorate([
        (0, common_1.Get)('nonce'),
        (0, swagger_1.ApiOperation)({ summary: 'Get nonce for wallet authentication' }),
    ...
    __decorate([
        ...
        (0, swagger_1.ApiOperation)({ summary: 'Verify signed message and authenticate' }),
