...
var update_progress_dto_1 = require("./dto/update-progress.dto");
var BadgesController = /** @class */ (function () {
    function BadgesController(badgesService) {
        this.badgesService = badgesService;
    }
    BadgesController.prototype.getUserBadges = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.badgesService.getUserBadges(address)];
            });
        });
    };
    BadgesController.prototype.getUserProgress = function (address, type) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.badgesService.getUserProgress(address, type)];
            });
        });
    };
    BadgesController.prototype.updateProgress = function (updateProgressDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.badgesService.updateProgress(updateProgressDto)];
            });
        });
    };
    BadgesController.prototype.getLeaderboard = function (type) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.badgesService.getLeaderboard(type)];
            });
        });
    };
    __decorate([
