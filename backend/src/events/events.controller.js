...
var EventsController = /** @class */ (function () {
    ...
    EventsController.prototype.createEvent = function (createEventDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.eventsService.createEvent(createEventDto)];
            });
        });
    };
    EventsController.prototype.getEvents = function (type, artistId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.eventsService.getEvents(type, artistId)];
            });
        });
    };
    EventsController.prototype.getEvent = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.eventsService.getEvent(id)];
            });
        });
    };
    EventsController.prototype.updateEvent = function (id, updateEventDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.eventsService.updateEvent(id, updateEventDto)];
            });
        });
    };
    EventsController.prototype.deleteEvent = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.eventsService.deleteEvent(id)];
            });
        });
    };
    EventsController.prototype.registerForEvent = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.eventsService.registerForEvent(id)];
            });
        });
    };
    __decorate([
