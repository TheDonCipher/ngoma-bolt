...
var create_merchandise_dto_1 = require("./dto/create-merchandise.dto");
var update_merchandise_dto_1 = require("./dto/update-merchandise.dto");
var MerchandiseController = /** @class */ (function () {
    function MerchandiseController(merchandiseService) {
        this.merchandiseService = merchandiseService;
    }
    MerchandiseController.prototype.createMerchandise = function (createMerchandiseDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.merchandiseService.createMerchandise(createMerchandiseDto)];
            });
        });
    };
    MerchandiseController.prototype.getMerchandise = function (type, artistId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.merchandiseService.getMerchandise(type, artistId)];
            });
        });
    };
    MerchandiseController.prototype.getMerchandiseById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.merchandiseService.getMerchandiseById(id)];
            });
        });
    };
    MerchandiseController.prototype.updateMerchandise = function (id, updateMerchandiseDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.merchandiseService.updateMerchandise(id, updateMerchandiseDto)];
            });
        });
    };
    MerchandiseController.prototype.deleteMerchandise = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.merchandiseService.deleteMerchandise(id)];
            });
        });
    };
    MerchandiseController.prototype.purchaseMerchandise = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.merchandiseService.purchaseMerchandise(id)];
            });
        });
    };
    __decorate([
