...
var RecoveryService = /** @class */ (function () {
    function RecoveryService(prisma, emailService, rateLimiter) {
        this.prisma = prisma;
        this.emailService = emailService;
        this.rateLimiter = rateLimiter;
    }
    RecoveryService.prototype.initiatePasswordReset = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // Rate limiting check
                    return [4 /*yield*/, this.rateLimiter.checkLimit('password-reset', email)];
                    case 1:
                        // Rate limiting check
                        _a.sent();
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.emailService.sendPasswordResetEmail(email, token)];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    RecoveryService.prototype.validateResetToken = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            var reset;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RecoveryService.prototype.resetPassword = function (token, newPassword) {
        return __awaiter(this, void 0, void 0, function () {
