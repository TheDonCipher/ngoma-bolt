...
var ProfileService = /** @class */ (function () {
    function ProfileService(prisma, cache) {
        this.prisma = prisma;
        this.cache = cache;
    }
    ...
    ProfileService.prototype.updateProfile = function (userId, data) {
        return __awaiter(this, void 0, void 0, function () {
            var profile;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prisma.userProfile.update({
                            where: { userId: userId },
    ...
    ProfileService.prototype.updateAvatar = function (userId, avatarUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var profile;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ProfileService.prototype.updatePrivacySettings = function (userId, settings) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prisma.userPreferences.update({
                            where: { userId: userId },
                            data: {
